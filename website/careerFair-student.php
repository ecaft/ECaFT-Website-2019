...
<body class="appear-animate">
    ...
    <div class="page" id="top">
        ...
        <!-- Head Section -->
        <section class="page-section bg-dark-alfa-30 parallax-3" data-background="images/career_fair_background.jpg">
            <!-- "images/full-width-images/section-bg-21.jpg"> -->
                    ...
                    <div class="tab-pane fade in active" id="service-branding">
                        ...
                        <div class="section-text">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-18 mb-sm-100 mb-xs-60">
                                    Whether it's your first time at the career fair (Hello Freshmen!) or your last time
                                    at the career fair (Goodbye Seniors!), we hope you're excited to join us at our
                                    annual Engineering Spring Career Fair! Please reach out to us at ecaft@cornell.edu
                                    if you have any questions before the career fair.
                                </div>
                    ...
                    <div class="tab-pane fade" id="service-web-design">
                        ...
                        <div class="section-text">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-18 mb-sm-100 mb-xs-60">
                                    <ul>
                                        <li>Several copies of your resume for multiple employers</li>
                                        <li>Pen</li>
                                        <li>A pad/notebook for jotting down quick notes</li>
                                        <li>Confidence and knowledge of company. Employers like to see students who can
                                            articulate their strengths and why they are excited about the company's
                                            work.</li>
                                    </ul>
                                </div>
                                <!-- <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                        ...
                        <div class="section-text">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                                    ...
                                    on the type of companies that they approach. Tech and Engineering companies tend to
                                    be more casual than Finance and Law companies.
                                </div>
                                <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                                    ...
                                    <ul>
                                        ...
                                        <li>Dress shoes</li>
                                        <li>Blazer/Suit jacket (optional)</li>
                                    ...
                                    <ul>
                                        ...
                                        <li>Sneakers, boots, or sandals</li>
                                        <li>Piercings on ear, nose, lip, etc.</li>
                                        <li>Jeans, shorts, baggy pants</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Call Action Section -->
        <section class="page-section pt-0 pb-0 banner-section bg-dark" data-background="images/students-bg.jpg">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="mt-140 mt-lg-80 mb-140 mb-lg-80">
                            <div class="banner-content">
                                <h3 class="banner-heading font-alt">Are you interested in seeing a specific employer at
                                    the Career Fair?</h3>
                                <div class="banner-decription">
                                    Email ecaft@cornell.edu with subject title "Student Employer Request" or click the
                                    button below to submit a request.
                                </div>
                                <div>
                                    <a href="https://docs.google.com/a/cornell.edu/forms/d/e/1FAIpQLSfJB-dDdoIhUCKkQF5aS_FE9nTRy6qjHGaTgQ833cS-Mf1njA/viewform" class="btn btn-mod btn-w btn-medium btn-round">Submit a Request</a>
                                </div>
                            </div>
                        </div>
